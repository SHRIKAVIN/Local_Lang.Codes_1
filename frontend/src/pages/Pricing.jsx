    ...
    <div className="min-h-screen bg-gray-50 py-8 md:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 sm:text-4xl">Pricing Plans</h1>
          <p className="mt-3 md:mt-4 text-base md:text-xl text-gray-600">Choose the perfect plan for your needs.</p>
        </div>

        <div className="grid grid-cols-1 gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {pricingTiers.map((tier) => (
            <div key={tier.name} className="flex flex-col rounded-lg shadow-lg overflow-hidden h-full">
              <div className="px-6 py-8 bg-white sm:p-8 md:p-10 md:pb-6 flex-grow">
                <div className="flex-grow">
                  ...
                  <p className="mt-4 flex items-baseline text-gray-900">
                    ...
                    <span className="ml-1 text-lg md:text-xl font-semibold text-gray-600">{tier.frequency}</span>
                  </p>
              ...
              <div className="px-6 py-6 bg-gray-50 sm:p-8 md:p-10 md:pt-6">
                 <a
                    href={tier.ctaLink}
